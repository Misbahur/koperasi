                    ...
                    <div class="card card-small mb-4">
                        ...
                        <div class="card-body p-0 pb-3 text-center">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr
                                        v-for="nasabah in nasabahs"
                                        :key="nasabah.id"
                                    >
                                        <td>
                                            <img
                                                :src="'images/' + nasabah.foto"
                            ...
                            <div class="float-right mr-2 mt-2">
                                <vue-pagination
                                    :data="nasabah"
                                    v-on:pagination-change-page="getNasabah"
                                    :limit="1"
                                ></vue-pagination>
                            </div>
                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <option
                                                                        v-for="identitas in options.identitas"
                                                                        :key="
                                                                            identitas.id
                                                                        "
                                                                    >
...
export default {
    ...
    methods: {
        getNasabah(page = 1) {
            ...
            axios
                .get("api/nasabah?q=" + this.pencarian + "&page=" + page)
                .then(
                    function (response) {
        ...
        updateForm() {
            axios
                .patch("nasabah/" + this.form.id, this.form)
                .then(
                    function (response) {
                        this.form = response.data;
                        this.update = true;
