<template>
    <div>
        <div v-if="update" class="mb-0 alert alert-info alert-dismissible fade show" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">×</span>
            </button>
            <i class="mx-2 fa fa-check"></i>
                        ...
                        <div class="card-header border-bottom">
                            <h6 class="m-0 d-flex justify-content-between">
                                <button type="button" class="btn btn-sm btn-pill btn-outline-primary" data-toggle="modal"
                                    ...
                                    <i class="mr-1 material-icons">attach_money</i>Tambah</button>
                                <form action="simpanan/report">
                                    <div class="form-inline">
                                        ...
                                        <button class="ml-1 btn btn-sm btn-primary"><i class="material-icons">print</i></button>
                                    </div>
                                </form>
                                <div>
