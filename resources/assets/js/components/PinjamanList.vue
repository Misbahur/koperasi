                    ...
                    <div class="card card-small mb-4">
                        ...
                        <div class="card-body p-0 pb-3">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr
                                        v-for="(pinjaman, index) in pinjamans"
                                        :key="pinjaman.id"
                                    >
                                        <td>{{ pinjaman.kode_transaksi }}</td>
                                        <td>{{ pinjaman.user.name }}</td>
                                        <td>
                                            {{ formatPrice(pinjaman.jumlah) }}
                                        </td>
                                        <td>
                                            {{
                                                formatPrice(
                                                    pinjaman.sudah_bayar
                                                )
                                            }}
                                        </td>
                                        <td>
                                            {{
                                                formatPrice(pinjaman.sisa_bayar)
                                            }}
                                        </td>
                            ...
                            <div class="float-right mr-2 mt-2">
                                <vue-pagination
                                    :data="pinjaman"
                                    v-on:pagination-change-page="getPinjaman"
                                    :limit="1"
                                ></vue-pagination>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            tabindex="-1"
                            role="dialog"
                            aria-labelledby="pinjamanModalLabel"
                            aria-hidden="true"
                        >
                            <div class="modal-dialog" role="document">
                                <form
                                    v-on:submit.prevent="
                                        edit ? saveForm() : updateForm()
                                    "
                                >
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                >
                                                    <option
                                                        v-for="user in options.selectUser"
                                                        :key="user.id"
                                                        :value="user.id"
                                                    >
                                                        {{
                                            ...
                                            <div class="form-group">
                                                ...
                                                >
                                                    <option
                                                        v-for="durasi in options.durasi"
                                                        :key="durasi.id"
                                                        :value="durasi.value"
                                                    >
                                                        {{ durasi.name }}
...
export default {
    ...
    methods: {
        ...
        getPinjaman(page = 1) {
            ...
            axios
                .get("api/pinjaman?q=" + this.pencarian + "&page=" + page)
                .then(
                    function (response) {
        ...
        deletePinjaman(id, kode_transaksi) {
            if (
                confirm(
                    "Yakin Ingin Menghapus Data Pinjaman " +
                        kode_transaksi +
                        " ?"
                )
            ) {
                axios
                    ...
                    .then(
                        function (response) {
                            alert(
                                "Berhasil Menghapus Kode Transaksi " +
                                    kode_transaksi
                            );
                            this.getPinjaman();
                        }.bind(this)
        ...
        updateForm() {
            axios
                .patch("pinjaman/" + this.form.id, this.form)
                .then(
                    function (response) {
                        this.form = response.data;
                        this.update = true;
