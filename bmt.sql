...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2022 at 01:32 PM
...
(7, '2021_12_09_005115_create_notifications_table', 1);
...
CREATE TABLE `notifications` (
  ...
  `type` enum('simpanan','pinjaman','pembayaran') COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `message` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `read` enum('true','false') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'home', 'web', '2022-01-12 07:21:29', '2022-01-12 07:21:29'),
(2, 'simpanan', 'web', '2022-01-12 07:21:29', '2022-01-12 07:21:29'),
(3, 'nasabah', 'web', '2022-01-12 07:21:29', '2022-01-12 07:21:29'),
(4, 'penarikan', 'web', '2022-01-12 07:21:29', '2022-01-12 07:21:29'),
(5, 'pinjaman', 'web', '2022-01-12 07:21:29', '2022-01-12 07:21:29'),
(6, 'roles', 'web', '2022-01-12 07:21:30', '2022-01-12 07:21:30'),
(7, 'laporan', 'web', '2022-01-12 07:21:30', '2022-01-12 07:21:30');
...
(1, 'nasabah', 'web', '2022-01-12 07:21:30', '2022-01-12 07:21:30'),
(2, 'pengelola', 'web', '2022-01-12 07:21:30', '2022-01-12 07:21:30'),
(3, 'admin', 'web', '2022-01-12 07:21:30', '2022-01-12 07:21:30');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `kelamin`, `no_anggota`, `agama`, `identitas`, `no_identitas`, `alamat`, `foto`, `status`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin@gmail.com', '$2y$10$jvclx75pxdcdEYv8CwGFYuZTqOzubwHJLrH7PgXWhMi6hLkSnCKYy', '', '', '', '', '', '', 'user.png', 1, 'BnRGrM4mJP096juAh68PNn0RYcLg2KvCpXv7W7Hrdc8Z3vkcJ040VMMsCnwO', '2022-01-12 07:21:30', '2022-01-12 07:21:30'),
(2, 'AQILLA FADIA', 'aqilla@gmail.com', '$2y$10$.0CyTTRPOxbR2RCuShf7xe52Fum.wNvws7xaz9L8P6yT0Er6OlEVm', 'Perempuan', 'BMTIM-220112-002', 'Islam', 'KTP', '1200000099999', 'Tegaldlimo', '1641972263.jpeg', 1, 'LCqKHoFKV40KGApYiS8ugemexAEHKfr5AqvO7qBwhc1VUYPZowTV7OLKpJnU', '2022-01-12 07:24:24', '2022-01-12 07:24:24');
